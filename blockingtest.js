...
<div id="usaOptOutModal" class="cookie-settings-modal usa-opt-out-modal">
        ...
        <div class="cookie-settings-body">
            ...
            <div class="usa-opt-out-option">
                <label class="usa-opt-out-toggle">
                    ...
                    <span class="usa-opt-out-label">Do Not Sell or Share My Personal Information</span>
                </label>
            </div>
        </div>
    ...
    .usa-opt-out-modal .cookie-settings-content {
        width: 400px !important; /* FIXED: Set to exact width like second image */
        max-height: 500px !important;
        padding: 24px !important; /* FIXED: Added padding like second image */
    ...
    /* ================================================================= */
    /* FIXED: SIMPLE CHECKBOX STYLES (like your second image) */
    /* ================================================================= */
    
    /* USA Opt-Out Container */
    .usa-opt-out-option {
    ...
    /* Simple Square Checkbox (like second image) */
    #usaDoNotSellCheckbox {
        ...
        appearance: checkbox !important; /* Force checkbox appearance */
        -webkit-appearance: checkbox !important;
        -moz-appearance: checkbox !important;
    }

    /* Remove ALL toggle-slider styles completely */
    .usa-toggle-slider {
    ...
    /* Modal Buttons - Gray like second image */
    .usa-cancel-button {
        background: #f8f9fa !important;
        color: #333 !important;
        border: 1px solid #e0e0e0 !important;
    ...
    @media (max-width: 768px) {
        ...
        .usa-opt-out-toggle {
            flex-direction: row !important; /* Keep checkbox and label on same line */
            align-items: center !important;
        }
    ...
    /* ================================================================= */
    /* REMOVE ALL DUPLICATE/OVERWRITING STYLES BELOW THIS LINE */
    /* ================================================================= */
    </style>`;
